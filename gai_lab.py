...
Original file is located at
    https://colab.research.google.com/drive/1JXA9Z7G9ooYPQcFfZwVgsP6J5la3H_rC
"""
...
import os
print(os.path.isfile('/content/reddy'))
...
input_image = Image.open('/content/REDDY1')
...
image = Image.open('/content/REDDY1')
